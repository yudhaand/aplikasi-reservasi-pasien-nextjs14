...
import { resetPasswordPasien } from "@/services/pasienService";

export default function PasienForgotPassword({ setClickRegister }) {
  ...
  return (
    <div className="flex flex-col p-4 gap-4">
      ...
      <div className="flex px-1 justify-between">
        ...
        <Link color="primary" size="sm" onClick={() => setClickRegister(true)}>
          Belum memiliki akun?
        </Link>
      </div>
    </div>
